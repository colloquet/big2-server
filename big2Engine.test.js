...
test('identify invalid combinations', () => {
  ...
  // triplets
  expect(big2Engine.validateCombination([new Card(1, 1), new Card(1, 2), new Card(2, 1)])).toBe(
    false,
  );

  // four
  expect(
    big2Engine.validateCombination([
      new Card(1, 1),
      new Card(1, 2),
      new Card(1, 3),
      new Card(1, 4),
...
test('identify valid moves', () => {
  ...
  // pairs
  expect(
    big2Engine.validateMove([new Card(13, 1), new Card(13, 2)], [new Card(1, 1), new Card(1, 2)]),
  ).toBe(true);
...
test('identify invalid moves', () => {
  ...
  // pairs
  expect(
    big2Engine.validateMove([new Card(1, 1), new Card(1, 2)], [new Card(13, 1), new Card(13, 2)]),
  ).toBe(false);
